...
This repository is not yet public (see `SECURITY.md`). Once it is
published, this section will name a real, working contact for reporting
Code of Conduct violations, consistent with this project's own rule against
publishing a contact channel that does not resolve. Until then, report a
concern the same way you would report any other issue — with the person who
gave you access to this source tree.
